...
export const experiences: ExperienceItem[] = [
  {
    ...
    company: 'Straitpoint Indonesia',
    companyLogo: 'straitpoint',
    location: 'Jakarta, Indonesia',
    period: 'Jun 2026 — Present',
    summary:
      'Building AI products that span recommendation systems and generative media, with a focus on production-ready video and image generation workflows.',
    highlights: [
      'Developing recommendation systems to personalize content and improve user engagement.',
      'Designing video and image generation workflows that turn generative models into reliable, repeatable production pipelines.',
    ],
  },
  {
    id: 1,
