...
const Hero = () => {
  return (
    <section id="hero" className="relative px-4 pb-24 pt-12 sm:px-6 sm:pb-16 sm:pt-20 lg:px-8 lg:pb-24 lg:pt-28 overflow-hidden bg-zinc-50/50 dark:bg-zinc-950/50">
      ...
      <div className="page-shell page-narrow relative z-10">
        <div className="flex flex-col-reverse md:grid items-center gap-8 md:gap-8 md:grid-cols-[1.3fr_0.7fr]">
          <motion.div
          ...
          >
            <div className="space-y-6">
              <h1 className="text-balance text-center md:text-left text-3xl font-bold leading-[1.1] tracking-tight text-zinc-950 dark:text-zinc-50 sm:text-4xl lg:text-5xl">
                Hi, I'm Royan Rosyad👋
              </h1>
              <div className="space-y-4">
                <p className="max-w-xl text-base leading-relaxed text-zinc-600 dark:text-zinc-400 sm:text-[1.1rem]">
          ...
          <motion.div
            ...
            className="mx-auto w-full max-w-[15rem] sm:max-w-[20rem] md:max-w-full"
          >
